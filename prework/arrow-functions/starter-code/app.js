...
// 1. What is "this" when joe.scope() is invoked?  go to the enclosing functional scope . 
//
// 2. What is "this" when joe.scopeArrow() is invoked? go to  global windows . 
//
// 3. Explain why "this" is different when an arrow function is used.  
  // arrow functions retain the this value of the enclosing functional scope.  we need any method  to use this to behave properly.
